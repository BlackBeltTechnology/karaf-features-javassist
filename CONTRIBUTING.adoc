# Contributing to karaf-features-javassist

## Installing the correct versions of Java, Maven and necessary dependencies

karaf-features-javassist is currently built on top of JDK 11.
...
You can file new issues by filling out our https://github.com/BlackBeltTechnology/karaf-features-javassist/issues/new/choose[issue form].
